...
class Plane:
    ...
    def __init__(self, model_type: str, name_suffix: str, model_speed_coeficient: float) -> None:
...
class Boeing(Plane):
    ...
    def __init__(self, model_type: str) -> None:
        ...
        super().__init__(model_type=model_type, name_suffix=self.NAME_SUFFICS, model_speed_coeficient=speed_coef)
